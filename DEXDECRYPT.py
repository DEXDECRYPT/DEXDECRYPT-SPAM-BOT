...
async def start_DEXDECRYPT():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await idk(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await ydk(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await wdk(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await hdk(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await sdk(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await adk(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await bdk(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await cdk(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await ddk(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await edk(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await vkk(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await kkk(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await lkk(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await mkk(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await sid(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await shy(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await aan(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await ake(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await eel(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await khu(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await shi(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await yaa(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await dav(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await raj(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@DEXDECRYPT"))
            await put(functions.channels.JoinChannelRequest(channel="@DOST_HAI_SAB"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
...
loop.run_until_complete(start_DEXDECRYPT())       
...
async def get_users(event):
    if event.sender_id in SMEX_USERS: 
        ...
        await krishna.edit(
            "**⚜️[Ͳєямιиαℓ Տτατυѕ](https://t.me/DOST_HAI_SAB)**\n\n`🔸Inviting Users.......`"
        )
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        DEXDECRYPT = ("".join(e.text.split(maxsplit=1)[1:])).split(" ", 1)     
        if len(e.text) > 5:
            bio = str(DEXDECRYPT[0])
            text = "Changing Bio"
            event = await e.reply(text, parse_mode=None, link_preview=None )
            try:
                await e.client(functions.account.UpdateProfileRequest(about=bio))
                await event.edit("Succesfully Changed Bio By DEXDECRYPT Spam Bot")
            except Exception as e:
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 6:
            ...
            try:
                ...
                await event.edit("𝐉𝐎𝐈𝐍 𝐒𝐔𝐂𝐂𝐄𝐒𝐒𝐅𝐔𝐋")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        DEXDECRYPT = ("".leave(e.text.split(maxsplit=1)[1:])).split(" ", 1)
        if len(e.text) == 7:
            bc = DEXDECRYPT[0]
            bc = int(bc)
            text = "DEXDECRYPT Spam Bot Leaving....."
            event = await e.reply(text, parse_mode=None, link_preview=None )
            try:
...
async def spam(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(DEXDECRYPT) == 2:
            message = str(DEXDECRYPT[1])
            counter = int(DEXDECRYPT[0])
            if counter > 100:
...
async def spam(e):
    ...
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
            return await e.reply(usage, parse_mode=None, link_preview=None )
        smex = await e.get_reply_message()
        DEXDECRYPT = "".join(e.text.split(maxsplit=1)[1:]).split(" ", 2)
        DEXDECRYPTop = DEXDECRYPT[1:]
        if len(DEXDECRYPTop) == 2:
            message = str(DEXDECRYPTop[1])
            counter = int(DEXDECRYPTop[0])
            sleeptime = float(DEXDECRYPT[0])
            for _ in range(counter):
...
async def help(e):
    if e.sender_id in SMEX_USERS:
       text = "⚜️𝐂𝐌𝐃'𝐒 𝐈𝐍 𝐃𝐄𝐗𝐃𝐄𝐂𝐑𝐘𝐏𝐓 𝐒𝐏𝐀𝐌 𝐁𝐎𝐓⚜️\n\n🔰𝐔𝐓𝐈𝐋𝐒 𝐂𝐎𝐌𝐌𝐀𝐍𝐃🔰\n.ping\n.restart\n\n🔰𝐔𝐒𝐄𝐑𝐁𝐎𝐓 𝐂𝐎𝐌𝐌𝐀𝐍𝐃🔰:\n.bio\n.join\n.leave\n.pjoin\n.pleave\n\n🔰𝐒𝐏𝐀𝐌 𝐂𝐎𝐌𝐌𝐀𝐍𝐃🔰:\n.spam\n.delayspam\n.bigspam\n.raid\nn\nFor more help regarding usage of plugins type plugins name"
       await e.reply(text, parse_mode=None, link_preview=None )
...
print(text)
print("")
print("SMEX! 𝐃𝐄𝐗𝐃𝐄𝐂𝐑𝐘𝐏𝐓 𝐒𝐏𝐀𝐌 𝐁𝐎𝐓 Started Sucessfully.")
