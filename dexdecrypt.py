...
USTAD_PIC = "https://telegra.ph/file/f9a63f0811c00fcbc01bd.jpg"
...
async def ping(e):
    if e.sender_id in SMEX_USERS:
        ...
        await event.edit(f"𝙉𝙄𝙆𝙃𝙄𝙇 𝙈𝙐𝙇𝙏𝙄 𝙎𝙋𝘼𝙈 😁\n`{ms}` 𝙢𝙨")
...
💥💥CONGRATULATIONS UR NIKHIL SPAM BOT IS READY💥💥💥
💥💥💥💥💥💥 BY OP NIKHIL 💥💥💥💥💥💥"""

print(text)
print("")
print("🙏🔥🔥NIKHIL MULTI SPAM BOT STARTED SUCCESFULLY.🔥🔥🙏")
